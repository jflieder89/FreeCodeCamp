...
"""
"""
I had a hard time implementing this concept, so I basically converted a javascript solution on
FreeCodeCamp to python in hopes of understanding it more as I went
"""
lst = [1,4,2,8,345,123,43,32,5643,63,123,43,2,55,1,234,92] #need to have a lst defined for the pivot function declaration with the len function involved
def swap(lst, a, b):
    lst[a], lst[b] = lst[b], lst[a]

def pivot(lst, left = 0, right = len(lst) - 1):
    shift = left
